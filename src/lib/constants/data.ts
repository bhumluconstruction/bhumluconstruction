...
export const projectsData: ProjectItem[] = [
  ...
  },
  {
    ...
    location: "Dang",
    status: "Completed",
    description: "Delivered the full 132kV transmission line survey and construction support for the Dang corridor, including route validation, tower spotting and commissioning readiness.",
    scope: "Detailed route alignment, topographic survey, tower spot checks, foundation design reviews and conductor stringing planning for a 132kV line across remote terrain.",
    timeline: "12 months from survey mobilization to commissioning.",
    client: "KEC international Ltd",
    outcome: "A fully commissioned transmission route with safer tower placement, optimized corridor alignment and reliable delivery for the Dang region.",
    details: [
      "Topographic survey across 72 km of ridge and valley.",
      "Tower foundation design with local material adaptation.",
      "Stringing and sagging with live-line safety protocols.",
